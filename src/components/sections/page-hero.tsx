...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden pb-16 pt-36 md:pb-24 md:pt-48">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_75%_20%,rgba(0,255,102,.2),transparent_26rem)]" />
      <div className="section-shell">
        <Reveal>
          <p className="mb-6 text-sm font-semibold uppercase tracking-[0.24em] text-acid">{eyebrow}</p>

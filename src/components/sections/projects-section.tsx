...
export function ProjectsSection() {
  ...
  return (
    <section ref={ref} className="depth-stage relative h-[360vh] py-20">
        ...
        <div className="section-shell w-full">
          ...
          <motion.div style={{ x }} className="flex w-max gap-5 will-change-transform">
            {projects.map((project, index) => (
              <article
                key={project.title}
                className="depth-card relative h-[56vh] w-[82vw] max-w-[980px] overflow-hidden rounded-[8px] border border-white/10 bg-panel p-6 md:w-[64vw] md:p-8"
              >
            ...
            <div className="depth-card relative grid h-[56vh] w-[72vw] max-w-[720px] place-items-center rounded-[8px] border border-dashed border-primary/40 bg-primary/5 p-8">
